...
export declare class QIM {
     ...
     */
    private static _exec;
    /**
     * Read File to Buffer
     * @param path Sys path or remote url
     * @return {Promise<Buffer>}
     */
    static read_to_buffer(path: string): Promise<Buffer>;
    /**
     * Identify an image
     * @param {string | Buffer} data
     * @returns {Promise<Info>}
     */
    static identify(data: string | Buffer): Promise<Info>;
    /**
     * Convert an Image
     ...
     * @return {Promise<Buffer>}
     */
    static convert(data: string | Buffer, args?: ConvertOptions, to_file?: string): Promise<Buffer>;
}
export declare const qim: typeof QIM;
export {};
