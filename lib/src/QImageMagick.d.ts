...
declare class Info {
    ...
    human_filesize(bytes: number): string;
    toString(): string;
}
/**
 * Read File to Buffer
 ...
 */
declare function read_to_buffer(path: string): Promise<Buffer>;
/**
 * Identify an image
 * @param {string | Buffer} data
 * @returns {Promise<Info>}
 */
declare function identify(data: string | Buffer): Promise<Info>;
/**
 * Convert an Image
 ...
 * @return {Promise<Buffer>}
 */
declare function convert(data: string | Buffer, args?: ConvertOptions, to_file?: string): Promise<Buffer>;
declare const version: any;
export declare const QIM: {
    read_to_buffer: typeof read_to_buffer;
